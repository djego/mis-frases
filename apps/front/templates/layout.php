          ...
          <?php else: ?>
            <div class="header-caja" id="header-link-color">
              ...
              <div class="header-entrado">
                <img width="16" height="16" border="0" src="/images/icon/entrar.png"><em>Bienvenido(a)&nbsp; <?php echo $sf_user->getGuardUser()->getUsername(); ?>&nbsp;<a href="<?php echo url_for('panel') ?>">Mi panel</a> | <a href="<?php echo url_for('logout') ?>">Salir </a>|</em>
              </div>
            </div>
            ...
            <div class="body-colum1-usuarios-cont-tabla" id="ul">
              <ul>
                ...
                <?php foreach ($lst_users as $user): ?>
                  ...
                  ?>
                  <li><a href="<?php echo $user['id'] ?>"><img src="/images/icon/<?php echo $img; ?>" width="44" height="44" border="1" /></a></li>
                <?php endforeach; ?>
