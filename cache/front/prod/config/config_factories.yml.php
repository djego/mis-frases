...
// date: 2011/07/26 01:51:21
  ...
  'cache_dir' => '/var/www/mis-frases/cache/front/prod/i18n',
  'lifetime' => 31556926,
  'prefix' => '/var/www/mis-frases/apps/front/i18n',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('tiggres'),
), sfConfig::get('sf_factory_storage_parameters', array (
  'session_name' => 'tiggres',
  'session_cookie_domain' => '.mis-frases.local',
  'auto_start' => true,
))));
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/var/www/mis-frases/cache/front/prod/template',
  'lifetime' => 86400,
  'prefix' => '/var/www/mis-frases/apps/front/template',
)));
...
$this->setMailerConfiguration(array_merge(array('class' => sfConfig::get('sf_factory_mailer', 'sfMailer')), sfConfig::get('sf_factory_mailer_parameters', array (
  ...
  array (
    ...
    array (
      ...
      'port' => 465,
      'encryption' => 'ssl',
      'username' => 'mis.frases.dev@gmail.com',
      'password' => '/<misfrases>/',
    ),
  ),
))));
