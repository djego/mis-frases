...
abstract class BasemfPhraseFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'counter_rate' => new sfWidgetFormFilterInput(),
      'value_rate'   => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'counter_rate' => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      'value_rate'   => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
